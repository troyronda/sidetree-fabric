...
FABRIC_TOOLS_TAG     ?= $(FABRIC_TOOLS_VERSION)
...
fabric-peer:
	...
	@mkdir -p ./.build/bin
	@cd cmd/peer && go build -ldflags "-s -w -linkmode external -extldflags '-static'" \
...
fabric-peer-docker:
	...
	@docker buildx build --platform=linux/arm64,linux/amd64 --push \
        ...
        -t troyronda/sidetree-fabric-peer:$(PROJECT_VERSION) \
